...
6. **Detroit – Industry CV** – A bold, graphical two-column template for industry and technical roles (engineering, manufacturing, operations, product). Features a full-height coloured sidebar, circular **skill rings**, proficiency **dots**, **tag chips** for tools, and a **timeline** of experience cards with an industrial steel-and-orange palette. Fits on 1–2 pages. Compiles with `pdflatex`.
